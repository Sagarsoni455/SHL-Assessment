...
This project addresses that challenge by automating the selection process using advanced Large Language Model (LLM) capabilities. By leveraging **Google’s Gemini 1.5 Flash** model and a tailored **Retrieval-Augmented Generation (RAG)** approach, the tool matches job descriptions against a historical dataset of verified assessments to provide accurate, data-driven recommendations.

## Key Features
- **AI-Powered Recommendations:** Uses the Gemini 1.5 Flash model to analyze Job Descriptions (JDs) and find the best matching SHL assessment.
